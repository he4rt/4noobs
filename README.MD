...
| Nome | Descrição | Contribuidores | Link |
| ------ | ------ | ------ | ------ |
| Arduino | O objetivo é ensinar o básico de Arduino para iniciantes. | [Henrique Bento](https://github.com/senhorbento) | [Clique aqui ➡️](https://github.com/senhorbento/Arduino4noobs) |
